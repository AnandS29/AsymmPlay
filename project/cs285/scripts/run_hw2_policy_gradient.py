...
class PG_Trainer(object):
    ...
    def run_training_loop(self):
        ...
        self.rl_trainer.run_training_loop(
            self.params['n_iter'],
            collect_policy_teacher = self.rl_trainer.agent_teacher.actor,
            collect_policy_student = self.rl_trainer.agent_student.actor,
            eval_policy = self.rl_trainer.agent_student.actor,
            )
