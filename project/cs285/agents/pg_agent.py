...
class PGAgent(BaseAgent):
    ...
    def train(self, obs, acs, rews_list, next_obs, terminals):
        ...
        # print("Shape of advantage_values: ", advantage_values.shape)
        # print("Shape of obs: ", obs.shape)
        # print("Shape of rews_list: ", len(rews_list))
        #return
    ...
    def _discounted_return(self, rewards):
        ...
        list_of_discounted_returns = [sum_of_discounted_rewards]*(len(rewards)) # len(rewards)-1
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)):
            ...
            discounts = [self.gamma**i for i in range(len(indices))]
            ...
            #discounted_rtg = [discounts[i]*rewards[i] for i in range(len(indices))]
            rew_ind = [rewards[i] for i in indices]
            discounted_rtg = [discounts[i]*rew_ind[i] for i in range(len(rew_ind))]
